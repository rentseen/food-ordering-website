...
<div class="container">
 ...
 <div class="form-group">
      <input type="text" name="restaurantname" id="restaurantname" class="form-control" placeholder="餐厅名称" />
   </div>
    <div class="form-group">
    ...
    {   
      ...
      if(restaurantname==null || restaurantname==""){
        ...
        alert("确认密码与密码不一致");
          ...
          user_register_form.action = "restaurant_register_process.php" ;
